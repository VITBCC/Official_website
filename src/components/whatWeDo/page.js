  ...
  return (
    ...
    >
      <div className="space-y-3">
        <div className="text-2xl text-yellow-500">{item.image}</div>
...
export default function OurWorks() {
  return (
    <div className="bg-[#110F0F] text-white p-8 flex flex-col items-center w-screen gap-y-6">
      <div className="text-2xl font-bold mb-4">Board Members - 2024</div>
      <div className="font-thin mb-8">
        Meet our board members fo the year 2024. 
      </div>
