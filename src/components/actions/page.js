...
const Circle = forwardRef(({ className, children }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex size-12 items-center justify-center rounded-full border-2 border-yellow-600 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
                className
            )}
        >
            {children}
...
export function AnimatedBeamMultipleOutputDemo({ className }) {
    ...
    return (
        <div
            className={cn(
                "relative flex h-[500px] items-center justify-center overflow-hidden bg-background p-10",
                className
            )}
            ref={containerRef}
        >
