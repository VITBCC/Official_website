  ...
  return (
    <div className="bg-gradient dark relative flex w-full items-center justify-center overflow-hidden bg-background p-20 md:shadow-xl h-screen">
      <div>
        ...
        <h1 className="z-10 text-gradient whitespace-pre-wrap text-center text-4xl lg:text-8xl font-bold tracking-normal text-black dark:text-white">
